...
- [x] Playwright E2E suite for the 6 critical flows.
...
| Presentation | 1 | Slides draft, demo script |
...
- [x] App reachable on AWS over HTTPS. ECS task-def, secrets, IAM, and pre-deploy Alembic one-off task merged (PRs [#83](https://github.com/Joshua0209/Asset-Management-System/pull/83), [#90](https://github.com/Joshua0209/Asset-Management-System/pull/90)); operator follow-ups in PRs [#93](https://github.com/Joshua0209/Asset-Management-System/pull/93), [#101](https://github.com/Joshua0209/Asset-Management-System/pull/101), [#102](https://github.com/Joshua0209/Asset-Management-System/pull/102), [#109](https://github.com/Joshua0209/Asset-Management-System/pull/109) unblocked the rolling deploy; ALB has an ACM cert + HTTPS:443 listener
- [x] Backend instrumented: OTLP traces, OTel metrics, OTel-bridged structured JSON logs (incl. per-request access log from PR [#85](https://github.com/Joshua0209/Asset-Management-System/pull/85)), Pyroscope profiles enabled in prod (PR [#89](https://github.com/Joshua0209/Asset-Management-System/pull/89) reversed the original "off in prod" decision; Basic-auth fix in PR [#113](https://github.com/Joshua0209/Asset-Management-System/pull/113))
- [x] Backend prod task definition runs `gunicorn --workers 1` (ECS scales via task count, aligned with the OTel SDK push model)
...
- [x] Six dashboards provisioned in repo (Operations Overview, Service Drilldown, Repair Journey, Logs/Traces/Profiles correlation, MySQL, Start Here) (PR [#78](https://github.com/Joshua0209/Asset-Management-System/pull/78)) and rendering real production telemetry after PRs [#96](https://github.com/Joshua0209/Asset-Management-System/pull/96), [#100](https://github.com/Joshua0209/Asset-Management-System/pull/100), [#103](https://github.com/Joshua0209/Asset-Management-System/pull/103), [#104](https://github.com/Joshua0209/Asset-Management-System/pull/104), [#105](https://github.com/Joshua0209/Asset-Management-System/pull/105), [#106](https://github.com/Joshua0209/Asset-Management-System/pull/106), [#110](https://github.com/Joshua0209/Asset-Management-System/pull/110), [#111](https://github.com/Joshua0209/Asset-Management-System/pull/111)
- [x] One end-to-end correlation walk verified live in GC: dashboard panel → Loki log line → Tempo trace → Pyroscope flamegraph for the same window
- [x] k6 load surface shipped (PR [#85](https://github.com/Joshua0209/Asset-Management-System/pull/85)). **Sustained peak QPS for 10 min + Grafana screenshots for slides still to run during buffer week**
- [ ] Stress test breakpoint documented (QPS at which P95 crosses 3s or error rate crosses 1%)
- [x] Playwright: 6 flows passing locally + in CI
...
| ~~**Playwright E2E suite still not authored as buffer week begins**~~ | ~~Active~~ Resolved | ~~Medium~~ | Six critical flows shipped (login, holder submit repair, manager approve, manager complete, asset search, register asset). Backup demo video still planned per the buffer-week table |
